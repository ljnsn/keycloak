...
<#macro kw providers=[]>
  <div class="pt-4 separate text-subtext0 text-sm">
    ...
    <#list providers as provider>
      <#switch provider.alias>
        ...
        <#case "twitter">
          ...
          <#break>
        <#default>
          <#assign colorClass="hover:bg-surface0">
      </#switch>

      <a
        class="${colorClass} border border-surface2 flex justify-center py-2 rounded-lg hover:border-transparent"
